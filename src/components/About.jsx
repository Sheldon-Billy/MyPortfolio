          ...
          <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                ...
                <p>📌 Still working on Projects, comleting course works etc.</p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  <br /> 📌 Maintained and serviced Network cables in Sever room{" "}
              ...
              <div>
                ...
                <p>
                  📌 Maintained and serviced Network cables in Sever room <br />{" "}
                  📌 Created and configured Network Models
                </p>
              </div>
            </div>
          </div>
